...
void Initialize(GLFWwindow *window) {
  ...
  g_BasicShader.LoadVertexShader("./assets/shaders/Scene.vs");
  g_BasicShader.LoadFragmentShader("./assets/shaders/Scene.fs");
...
void Display(GLFWwindow *window) {
  ...
  g_FBO[0].DrawColorBuffer(width, height, {-0.75, 0.75, 0}, 4);
